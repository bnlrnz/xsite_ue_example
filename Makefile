...
xsite_ue_example-Linux-Debug:
	 $(PROJECTBUILD) xsite_ue_example Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

xsite_ue_example-Linux-DebugGame:
	 $(PROJECTBUILD) xsite_ue_example Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

xsite_ue_example-Linux-Shipping:
	 $(PROJECTBUILD) xsite_ue_example Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

xsite_ue_example-Linux-Test:
	 $(PROJECTBUILD) xsite_ue_example Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

xsite_ue_example:
	 $(PROJECTBUILD) xsite_ue_example Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

xsite_ue_exampleEditor-Linux-Debug:
	 $(PROJECTBUILD) xsite_ue_exampleEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

xsite_ue_exampleEditor-Linux-DebugGame:
	 $(PROJECTBUILD) xsite_ue_exampleEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

xsite_ue_exampleEditor-Linux-Shipping:
	 $(PROJECTBUILD) xsite_ue_exampleEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

xsite_ue_exampleEditor-Linux-Test:
	 $(PROJECTBUILD) xsite_ue_exampleEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

xsite_ue_exampleEditor:
	 $(PROJECTBUILD) xsite_ue_exampleEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
