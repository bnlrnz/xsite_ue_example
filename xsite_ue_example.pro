...
unrealRootPath=/run/media/lorenz/Workspace/UnrealEngine
xsite_ue_exampleRootPath=/home/lorenz/Workspace/xsite_ue_example

gameProjectFile=/home/lorenz/Workspace/xsite_ue_example/xsite_ue_example.uproject
...
include(xsite_ue_exampleSource.pri)
include(xsite_ue_exampleHeader.pri)
include(xsite_ue_exampleConfig.pri)
include(xsite_ue_exampleIncludes.pri)
include(xsite_ue_exampleDefines.pri)

xsite_ue_example-Linux-Debug.commands = $$build xsite_ue_example Linux Debug  -project="\"$$gameProjectFile\"" $$args
xsite_ue_example-Linux-DebugGame.commands = $$build xsite_ue_example Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
xsite_ue_example-Linux-Shipping.commands = $$build xsite_ue_example Linux Shipping  -project="\"$$gameProjectFile\"" $$args
xsite_ue_example-Linux-Test.commands = $$build xsite_ue_example Linux Test  -project="\"$$gameProjectFile\"" $$args
xsite_ue_example.commands = $$build xsite_ue_example Linux Development  -project="\"$$gameProjectFile\"" $$args

xsite_ue_exampleEditor-Linux-Debug.commands = $$build xsite_ue_exampleEditor Linux Debug  -project="\"$$gameProjectFile\"" $$args
xsite_ue_exampleEditor-Linux-DebugGame.commands = $$build xsite_ue_exampleEditor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
xsite_ue_exampleEditor-Linux-Shipping.commands = $$build xsite_ue_exampleEditor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
xsite_ue_exampleEditor-Linux-Test.commands = $$build xsite_ue_exampleEditor Linux Test  -project="\"$$gameProjectFile\"" $$args
xsite_ue_exampleEditor.commands = $$build xsite_ue_exampleEditor Linux Development  -project="\"$$gameProjectFile\"" $$args
...
QMAKE_EXTRA_TARGETS += \ 
	xsite_ue_example-Linux-Debug \
	xsite_ue_example-Linux-DebugGame \
	xsite_ue_example-Linux-Shipping \
	xsite_ue_example-Linux-Test \
	xsite_ue_example \
	xsite_ue_exampleEditor-Linux-Debug \
	xsite_ue_exampleEditor-Linux-DebugGame \
	xsite_ue_exampleEditor-Linux-Shipping \
	xsite_ue_exampleEditor-Linux-Test \
	xsite_ue_exampleEditor \
